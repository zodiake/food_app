...
config :food_app, FoodAppWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: FoodAppWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: FoodApp.PubSub,
  live_view: [signing_salt: "BpfEDEZA"]
...
config :food_app, FoodApp.Mailer, adapter: Swoosh.Adapters.Local
